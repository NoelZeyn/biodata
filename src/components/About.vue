    ...
    <div class="container mx-auto px-6">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-6 text-gray-700">
          ...
          <p>
            Beyond frontend and backend development, I’ve also taken part in projects as a DevOps and QA engineer, allowing
            me to support the entire software lifecycle — from CI/CD setup to testing and deployment.
          </p>
          <p>
            I specialize in developing RESTful APIs, integrating third-party services, and managing cloud infrastructure to
